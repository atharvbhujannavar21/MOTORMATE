...
def edit(mid):
    if 'user' in session and session['user'] == params['user']:
        ...
        flash("You need to be logged in to edit this post.", "danger")
        return redirect('/login')
...
def delete(mid):
    if 'user' in session and session['user'] == params['user']:
        ...
        flash("You need to be logged in to delete this post.", "danger")
    return redirect('/login')
...
def deletemp(id):
    if 'user' in session and session['user'] == params['user']:
        ...
        flash("You need to be logged in to delete this item.", "danger")
...
def medicine():
    ...
    return render_template('spares.html', params=params)
